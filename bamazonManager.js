          ...
          inquirer
            .prompt({
              ...
              message:
                ...
                chalk.blue.bold(` '${res[0].product_name}'. `) +
                `Is this correct?`
            })
            .then(answer => {
              if (answer.confirm) {
    ...
    .then(answer => {
      ...
      connection.query(
        ...
        [
          {
            stock_quantity:
              Number(itemToUpdate.stock_quantity) + Number(answer.howMany)
          },
          {
        ...
        (err, res) => {
          console.log(
            chalk.blue.bold(
              ...
              }' now has ${Number(itemToUpdate.stock_quantity) +
                Number(itemToUpdate.howMany)} items in stock\n`
            )
          );
          connection.end();
        }
